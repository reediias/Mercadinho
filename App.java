...
public class App{
    ...
    //funcao para mostrar opcoes disponiveis no mercadinho
    private static void mostrarOpcoes(Scanner scanner, Carrinho carrinho){
        ...
        switch(escolha1){
            case 1:
                mostrarProdutos(scanner, "Frutas",
                                new String[]{"Mamão", "Banana", "Goiaba", "Pêra", "Melancia", "Manga"}, 
                                new double[]{3.0, 1.0, 2.5, 4.0, 5.0, 3.5}, carrinho);
                break;
                
            case 2:
                mostrarProdutos(scanner, "Legumes", 
                                new String[]{"Couve", "Batata", "Cenoura", "Abobrinha", "Alface", "Tomate"}, 
                                new double[]{2.0, 1.5, 2.0, 3.0, 2.5, 4.0}, carrinho);
                break;
                
            case 3:
                mostrarProdutos(scanner, "Laticínios", 
                                new String[]{"Leite", "Queijo", "Danone", "Requeijão", "Manteiga", "Creme de Leite"}, 
                                new double[]{4.0, 25.0, 2.0, 6.0, 7.0, 3.0}, carrinho);
                break;
                
            case 4:
                mostrarProdutos(scanner, "Açougue", 
                                new String[]{"Carne de sol", "Carne de porco", "Frango", "Presunto", "Linguiça", "Carne de hambúrguer"}, 
                                new double[]{40.0, 30.0, 15.0, 25.0, 20.0, 25.0}, carrinho);
                break;
    ...
    //funcao de mostrar todos os produtos com o codigo e tudo
